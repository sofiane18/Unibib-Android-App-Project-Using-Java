...
public class AdminMainAppProfileFragment extends Fragment {
    private SharedPreferences sp;
    private SharedPreferences.Editor spEditor;
    private TextView name,email,ref,account,birthDate,gender,phone,address,inviteCode;
    private Button logout;
    private final String EMAIL = "email";
    private final String ACCOUNT_MODE = "mode";
    private static final String ROOT_URL = "http://192.168.1.106/";

    public AdminMainAppProfileFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.admin_main_app_profile_fragment, container, false);
        ...
        inviteCode = v.findViewById(R.id.invateCode);
        ...
        String URL = ROOT_URL + "Android/Unibib/v1/admin/operations/profile/getAdminProfileInfo.php";
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for(int i =0;i<profiles.length();i++){
                                ...
                                inviteCode.setText("invitation Code : "+profile.getString("code"));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        dialog.show(((FragmentActivity)AdminMainAppProfileFragment.this.getContext()).getSupportFragmentManager(), "no internet connection dialog");
