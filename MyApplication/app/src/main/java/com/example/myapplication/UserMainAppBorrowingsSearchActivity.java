...
public class UserMainAppBorrowingsSearchActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_main_app_borrowings_search_activity);
    ...
    public void loadBorrowings(String q,String s){
        ...
        String URL = ROOT_URL + "Android/Unibib/v1/user/operations/borrowings/getSearchBorrowings.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            borrowingsRecyclerView.setAdapter(new UserBorrowingsRecyclerViewAdapter(borrowingsList,UserMainAppBorrowingsSearchActivity.this));
    ...
    public void showPopupMenu(View view){
        ...
        popupMenu.inflate(R.menu.user_borrowings_search_by_options_menu);
