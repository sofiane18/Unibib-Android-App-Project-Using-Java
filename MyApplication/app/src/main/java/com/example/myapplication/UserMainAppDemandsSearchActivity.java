...
public class UserMainAppDemandsSearchActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_main_app_demands_search_activity);
    ...
    public void loadDemands(String q,String s){
        ...
        String DEMANDS_URL = ROOT_URL + "Android/Unibib/v1/user/operations/demands/getSearchDemands.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            demandsRecyclerView.setAdapter(new UserDemandsRecyclerViewAdapter(demandsList,UserMainAppDemandsSearchActivity.this));
    ...
    public void showPopupMenu(View view){
        ...
        popupMenu.inflate(R.menu.user_demands_search_by_options_menu);
