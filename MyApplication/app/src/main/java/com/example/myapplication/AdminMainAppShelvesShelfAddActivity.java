...
public class AdminMainAppShelvesShelfAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button add = findViewById(R.id.adminShelfAddAddButton);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i==0){
                    String SHELVES_URL = ROOT_URL + "Android/Unibib/v1/admin/operations/shelves/addShelf.php";
