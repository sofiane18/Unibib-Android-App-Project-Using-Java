...
public class AdminDemandsRecyclerViewAdapter  extends RecyclerView.Adapter<AdminDemandsRecyclerViewAdapter.DemandViewHolder>  {
    ...
    public AdminDemandsRecyclerViewAdapter(ArrayList<AdminDemandsDemandItem> demandsList, Context context) {
    ...
    @NonNull
    @Override
    public AdminDemandsRecyclerViewAdapter.DemandViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.admin_main_app_demands_demand_cardview,parent,false);



        return new AdminDemandsRecyclerViewAdapter.DemandViewHolder(view);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull AdminDemandsRecyclerViewAdapter.DemandViewHolder holder, int position) {

        AdminDemandsDemandItem demandItem = demandsList.get(position);

        holder.title.setText(demandItem.bookItem.getTitle());
        holder.place.setText("Place: " + demandItem.bookItem.getPlace());
        holder.quantity.setText("Quantity: "+ demandItem.bookItem.getQuantity());
        holder.name.setText("" + demandItem.userItem.getLName() + " "+ demandItem.userItem.getFName());
        holder.id.setText("UserID : "+ demandItem.userItem.getRef());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(),AdminMainAppDemandsDemandViewActivity.class);
        ...
        switch (demandItem.getStatus()){
            case "ready":{
                holder.leftButton.setText("EXCUSE");
                holder.rightButton.setText("APPROVE");

                holder.leftButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        operationButton(demandItem.getRef(),"excuseDemand");
                    }
                });
                ...
                holder.rightButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        operationButton(demandItem.getRef(),"approveDemand");
                    }
                });
            ...
            case "approved":{
                ...
                holder.rightButton.setText("DELIVERED");
                ...
                holder.rightButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        operationButton(demandItem.getRef(),"deliveredDemand");
                    }
                });
            }
                break;
