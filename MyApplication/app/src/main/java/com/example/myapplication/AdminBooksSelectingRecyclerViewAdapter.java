...
public class AdminBooksSelectingRecyclerViewAdapter extends RecyclerView.Adapter<AdminBooksSelectingRecyclerViewAdapter.BookViewHolder> implements ConfirmationDialogDeleteBook.ConfirmationDialogDeleteBookListener {
    ...
    private ImageButton optionItem = null;
    private AdminBooksBookItem bookItemP;
    private View itemViewP;
    public AdminBooksSelectingRecyclerViewAdapter(ArrayList<AdminBooksBookItem> booksList, Context context) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(cardViewItem!=null){
                    ...
                    //optionItem.setBackgroundColor(ContextCompat.getColor(context,R.color.unselected));
                    optionItem.getBackground().setColorFilter(Color.parseColor("#121212"), PorterDuff.Mode.SRC_ATOP);
                }
                cardViewItem = holder.bookCardView;
                optionItem = holder.option;
                holder.bookCardView.setBackgroundColor(ContextCompat.getColor(context,R.color.selected));
                //holder.option.setBackgroundColor(ContextCompat.getColor(context,R.color.selected));
                holder.option.getBackground().setColorFilter(ContextCompat.getColor(context,R.color.selected), PorterDuff.Mode.SRC_ATOP);
                ...
                Intent intent = new Intent("selectedBook");
                intent.putExtra("selectedBook",bookBundle);
    ...
    public static class BookViewHolder extends RecyclerView.ViewHolder{
        ...
        private final CardView bookCardView;
