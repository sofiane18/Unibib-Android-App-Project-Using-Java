...
public class UserSignUpConnectInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_sign_up_connect_info_activity);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i==0){
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if(responseObj.getString("error").equals("false")){
                                    ...
                                    spEditor = sp.edit();
                                    spEditor.putString(ACCOUNT_MODE,"user");
                    ...
                    Volley.newRequestQueue(UserSignUpConnectInfoActivity.this).add(stringRequest);
