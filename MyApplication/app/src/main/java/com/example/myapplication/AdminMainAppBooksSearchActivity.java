...
public class AdminMainAppBooksSearchActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener, ConfirmationDialogDeleteBook.ConfirmationDialogDeleteBookListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_main_app_books_search_activity);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            booksRecyclerView.setAdapter(adminBooksRecyclerViewAdapter = new AdminBooksRecyclerViewAdapter(booksList,AdminMainAppBooksSearchActivity.this));
    ...
    public void onDeleteBookYesClicked() {
        adminBooksRecyclerViewAdapter.onDeleteBookYesClicked();
    }
