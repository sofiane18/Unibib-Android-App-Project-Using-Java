...
public class UserSearchBooksRecyclerViewAdapter extends RecyclerView.Adapter<UserSearchBooksRecyclerViewAdapter.BookViewHolder>{
    ...
    public UserSearchBooksRecyclerViewAdapter(ArrayList<AdminBooksBookItem> booksList,ArrayList<Integer> demandItList, ArrayList<Integer> fullDemandsList, Context context)  {
    ...
    public BookViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.user_main_app_books_search_book_cardview,parent,false);
    ...
    public void onBindViewHolder(@NonNull BookViewHolder holder, int position) {
        ...
        holder.tags.setText("Tags: " + bookItem.getTags());
    ...
    public static class BookViewHolder extends RecyclerView.ViewHolder{
        ...
        public BookViewHolder(@NonNull View itemView) {
            ...
            demandButton = itemView.findViewById(R.id.left_button);
