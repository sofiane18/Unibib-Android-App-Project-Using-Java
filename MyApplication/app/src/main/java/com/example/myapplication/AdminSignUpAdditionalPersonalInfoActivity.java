...
public class AdminSignUpAdditionalPersonalInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_sign_up_additional_personal_info_activity);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i==0){
                    ...
                    Intent intent = new Intent(v.getContext(), AdminSignUpConnectInfoActivity.class);
