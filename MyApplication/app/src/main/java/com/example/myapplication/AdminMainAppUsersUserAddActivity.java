...
public class AdminMainAppUsersUserAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_main_app_users_user_add_activity);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i==0){
                    ...
                    Intent intent = new Intent(v.getContext(), AdminMainAppUsersUserAddAdditionalPersonalInfoActivity.class);
