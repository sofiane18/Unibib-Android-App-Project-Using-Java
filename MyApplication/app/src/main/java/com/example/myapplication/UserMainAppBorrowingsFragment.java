...
public class UserMainAppBorrowingsFragment extends Fragment {
    public UserMainAppBorrowingsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.user_main_app_borrowings_fragment, container, false);
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(),UserMainAppBorrowingsSearchActivity.class);
    ...
    public void loadBorrowings(){
        ...
        String URL = ROOT_URL + "Android/Unibib/v1/user/operations/borrowings/getBorrowingsListRecyclerView.php";
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            borrowingsRecyclerView.setAdapter(new UserBorrowingsRecyclerViewAdapter(borrowingsList, context));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        dialog.show(((FragmentActivity)UserMainAppBorrowingsFragment.this.getContext()).getSupportFragmentManager(), "no internet connection dialog");
