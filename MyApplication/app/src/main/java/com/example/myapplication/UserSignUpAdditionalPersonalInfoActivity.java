...
public class UserSignUpAdditionalPersonalInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_sign_up_additional_personal_info_activity);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i==0){
                    ...
                    Intent intent = new Intent(v.getContext(), UserSignUpConnectInfoActivity.class);
